...
namespace Ecommerce.SharedViews
{
    ...
    public partial class RatingBar : ContentView
    {
        ...
        private static void fillStar(int selectedValue, RatingBar obj)
        {
        ...
        private static void EmptyStarImagePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (control != null)
            {
                ...
                // < customcontrol:RatingBar x:Name = "customRatingBar"  ImageWidth = "25" ImageHeight = "25" SelectedStarValue = "1"    FillStarImage = "fillstar" EmptyStarImage = "emptystar" />
        ...
        private static void FlowDirectionPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (control != null)
            {
                ...
                if (flowDirection == FlowDirectionEnum.RightToLeft)
                {
                    ...
                    control.stkRatingbar.Children.Add(control.star1);
                    control.stkRatingbar.Children.Add(control.star2);
                    control.stkRatingbar.Children.Add(control.star3);
                    control.stkRatingbar.Children.Add(control.star4);
                    control.stkRatingbar.Children.Add(control.star5);
                }
